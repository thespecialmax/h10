...
function benedicta_portfolio_filter() {
	"use strict";
	jQuery(".optionset li.selected > a").addClass("selected");
...
jQuery(window).load(function () {
	"use strict";
	benedicta_portfolio_filter();
	jQuery(".optionset li").eq(0).find("a").on('click touchend');
});
